...
public class PreviousLookActionTest extends InstrumentationTestCase {
	...
	public void testPreviousLook() {
		...
		SetLookAction setLookAction = (SetLookAction) sprite.getActionFactory().createSetLookAction(sprite, lookData1);
		NextLookAction nextLookAction = (NextLookAction) sprite.getActionFactory().createNextLookAction(sprite);
		...
		PreviousLookAction previousLookAction = (PreviousLookAction) sprite.getActionFactory().createPreviousLookAction(sprite);
	...
	public void testLastLook() {
		...
		Action setLookAction = sprite.getActionFactory().createSetLookAction(sprite, lookData1);
		Action previousLookAction = sprite.getActionFactory().createPreviousLookAction(sprite);
