...
public class WaitUntilActionTest extends AndroidTestCase {
	...
	private String testUservariable = "testUservariable";
	...
	protected void setUp() throws Exception {
		...
		ProjectManager.getInstance().getCurrentProject().getDataContainer().deleteUserVariableByName(testUservariable);
		ProjectManager.getInstance().getCurrentProject().getDataContainer().addProjectUserVariable(testUservariable);
	}
