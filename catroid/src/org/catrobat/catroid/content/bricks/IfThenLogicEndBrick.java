...
public class IfThenLogicEndBrick extends BrickBaseType implements NestingBrick, AllowedAfterDeadEndBrick {
	...
	public IfThenLogicBeginBrick getIfThenBeginBrick() {
		return ifBeginBrick;
	}
	...
	public View getView(Context context, int brickId, BaseAdapter baseAdapter) {
		...
		view = View.inflate(context, R.layout.brick_if_then_end_if, null);
		view = getViewWithAlpha(alphaValue);

		setCheckboxView(R.id.brick_if_then_end_if_checkbox);
	...
	public View getViewWithAlpha(int alphaValue) {
		...
		if (view != null) {
			...
			View layout = view.findViewById(R.id.brick_if_then_end_if_layout);
			Drawable background = layout.getBackground();
			background.setAlpha(alphaValue);

			TextView ifEndLabel = (TextView) view.findViewById(R.id.brick_if_then_end_if_label);
	...
	public View getPrototypeView(Context context) {
		return View.inflate(context, R.layout.brick_if_then_end_if, null);
	}
