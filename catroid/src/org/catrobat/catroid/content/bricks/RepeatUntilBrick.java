...
public class RepeatUntilBrick extends FormulaBrick implements LoopBeginBrick {
	...
	public View getPrototypeView(Context context) {
		...
		textRepeat.setText(String.valueOf(BrickValues.REPEAT_UNTIL_CONDITION));
	...
	public List<SequenceAction> addActionToSequence(Sprite sprite, SequenceAction sequence) {
		...
		Action action = ExtendedActions.repeatUntil(sprite, getFormulaWithBrickField(BrickField.REPEAT_UNTIL_CONDITION),
				repeatSequence);
